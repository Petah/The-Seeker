///// Fonction permettant de projeter des ombres pour une sprite /////
//Usage: SL_cast_sprite(layer,cast_sun,cast_amb,cast_lights,sprite,subimg,x,y,z,xscale,yxscale,rot,alpha);
